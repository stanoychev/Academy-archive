...
namespace Online_Store_Tests.Commands.ProductCommands.AddProductCommandTests
{
    ...
    public class Constructor_Should
    {
        ...
        public void ThrowException_WhenContextIsNull()
        {
            ...
            // Act && Assert
            Assert.ThrowsException<ArgumentNullException>(() => new AddProductCommand(null, writerMock.Object,
        ...
        public void ThrowException_WhenWritertIsNull()
        {
            ...
            // Act && Assert
            Assert.ThrowsException<ArgumentNullException>(() => new AddProductCommand(contextMock.Object,
