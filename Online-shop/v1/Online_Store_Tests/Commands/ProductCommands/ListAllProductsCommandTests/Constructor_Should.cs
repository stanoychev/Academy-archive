...
namespace Online_Store_Tests.Commands.ProductCommands.ListAllProductsCommandTests
{
    ...
    public class Constructor_Should
    {
        ...
        public void ThrowException_WhenContextIsNull()
        {
            ...
            // Act && Assert
            Assert.ThrowsException<ArgumentNullException>(() => new ListAllProductsCommand(null, writerMock.Object,
        ...
        public void ThrowException_WhenWritertIsNull()
        {
            ...
            // Act && Assert
            Assert.ThrowsException<ArgumentNullException>(() => new ListAllProductsCommand(contextMock.Object,
