...
namespace Online_Store_Tests.Commands.ProductCommands.ListProductsByCategoryCommandTests
{
    ...
    public class Constructor_Should
    {
        ...
        public void ThrowException_WhenContextIsNull()
        {
            ...
            // Act && Assert
            Assert.ThrowsException<ArgumentNullException>(() => new ListProductsByCategoryCommand(null, writerMock.Object,
        ...
        public void ThrowException_WhenWritertIsNull()
        {
            ...
            // Act && Assert
            Assert.ThrowsException<ArgumentNullException>(() => new ListProductsByCategoryCommand(contextMock.Object,
