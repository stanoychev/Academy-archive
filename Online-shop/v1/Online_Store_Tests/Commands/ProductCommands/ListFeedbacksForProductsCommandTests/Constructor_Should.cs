...
namespace Online_Store_Tests.Commands.ProductCommands.ListFeedbacksForProductsCommandTests
{
    [TestClass]
    public class Constructor_Should
    {
        ...
        public void ThrowException_WhenContextIsNull()
        {
            ...
            // Act && Assert
            Assert.ThrowsException<ArgumentNullException>(() => new ListFeedbacksForProductCommand(null, writerMock.Object,
        ...
        public void ThrowException_WhenWritertIsNull()
        {
            ...
            // Act && Assert
            Assert.ThrowsException<ArgumentNullException>(() => new ListFeedbacksForProductCommand(contextMock.Object,
