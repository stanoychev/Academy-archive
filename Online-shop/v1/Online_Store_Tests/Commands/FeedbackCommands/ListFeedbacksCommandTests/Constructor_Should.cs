...
namespace Online_Store_Tests.Commands.FeedbackCommands.ListFeedbacksCommandTests
{
    ...
    public class Constructor_Should
    {
        ...
        public void ThrowException_WhenIStoreContextIsNull()
        {
            ...
            new ListFeedbacksCommand(context, writer.Object, reader.Object));
        }
        ...
        public void ThrowException_WhenIWriterIsNull()
        {
            ...
            //act and assert
            Assert.ThrowsException<ArgumentNullException>(() =>
            new ListFeedbacksCommand(context.Object, writer, reader.Object));
        }
        ...
        public void ThrowException_WhenIReaderIsNull()
        {
            ...
            //act and assert
            Assert.ThrowsException<ArgumentNullException>(() =>
            new ListFeedbacksCommand(context.Object, writer.Object, reader));
        }
    }
}
